    ...
    <Private>
      ...
      <Paper>
        <Table
          ...
          data={[
            { id: 1, name: 'Fulano de tal', phone: '(99) 99999-9999', login: 'fulano_login', inital_date: '09/09/2019', status: 1, team: 'Alfas' },
            { id: 2, name: 'Fulano de tal', phone: '(99) 99999-9999', login: 'fulano_login', inital_date: '09/09/2019', status: 1, team: 'Alfas' },
            { id: 3, name: 'Fulano de tal', phone: '(99) 99999-9999', login: 'fulano_login', inital_date: '09/09/2019', status: 0, team: 'Alfas' },
            { id: 4, name: 'Fulano de tal', phone: '(99) 99999-9999', login: 'fulano_login', inital_date: '09/09/2019', status: 1, team: 'Alfas' },
          ]}
        />
      </Paper>
